...
void displayWelcomeMessage() {
    ...
    SDL_Surface* surfaceMessage = TTF_RenderText_Solid(font, "BIENVENIDOS A ZOMDOOM, PODRAS LLEGAR VIVO A LA SALIDA? BUENA SUERTE!", textColor);
...
void displayWinningMessage() {
    ...
    SDL_Color textColor = { 255, 255, 255, 255 };
    SDL_Surface* surfaceMessage = TTF_RenderText_Solid(font, "GANASTE!, SALISTE VIVO BUEN TRABAJO!!", textColor);
    SDL_Texture* welcomeMessage = SDL_CreateTextureFromSurface(renderer, surfaceMessage);
...
void displayLosingMessage() {
    ...
    SDL_Color textColor = { 255, 255, 255, 255 };
    SDL_Surface* surfaceMessage = TTF_RenderText_Solid(font, "PERDISTE!, INTENTA DE NUEVO :-)", textColor);
    SDL_Texture* welcomeMessage = SDL_CreateTextureFromSurface(renderer, surfaceMessage);
...
int main() {
    ...
    Mix_Chunk* soundEffect = Mix_LoadWAV("assets/paso.mp3");
    if (!soundEffect) {
    ...
    // Load the images
    ImageLoader::init();
    ImageLoader::loadImage("+", "assets/mu1.png");
    ImageLoader::loadImage("-", "assets/mu3.png");
    ImageLoader::loadImage("|", "assets/mu3.png");
    ImageLoader::loadImage("*", "assets/mu2.png");
    ImageLoader::loadImage("g", "assets/fi1.png");
    ImageLoader::loadImage("p", "assets/Ani2.png");
    ImageLoader::loadImage("pg", "assets/Anim2.png");
